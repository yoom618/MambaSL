...
# UEA_MTSC30=("DuckDuckGeese" "Epilepsy" "ERing")
# UEA_MTSC30=("EigenWorms") # GPU 1
# UEA_MTSC30=("FaceDetection" "FingerMovements" "HandMovementDirection" "Handwriting" "Heartbeat")
# UEA_MTSC30=("InsectWingbeat" "JapaneseVowels" )
# UEA_MTSC30=("Libras" "LSST" "MotorImagery") # GPU 3
# UEA_MTSC30=("NATOPS" "PEMS-SF" "PenDigits" "PhonemeSpectra" "RacketSports") # GPU 3
# UEA_MTSC30=("SelfRegulationSCP1" "SelfRegulationSCP2"  "SpokenArabicDigits" "StandWalkJump" "UWaveGestureLibrary") # GPU 3


UEA_MTSC30=("")
model="TimeMixerPP_CLS"
