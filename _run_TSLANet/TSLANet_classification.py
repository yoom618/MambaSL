...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default=r'lightning_logs')
    ...
    CHECKPOINT_PATH = f"{args.save_path}/{run_description}"
    ...
    # load datasets ...
    train_loader, val_loader, test_loader, class_names, seq_len, num_channels = get_datasets(DATASET_PATH, args)
